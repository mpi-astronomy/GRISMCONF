...
def POLY11(e, x, y, t):
    return (
        e[0, 0] + x * e[0, 1] + y * e[0, 2] + t * (e[1, 0] + x * e[1, 1] + y * e[1, 2])
    )
...
def INVPOLY11(e, x, y, d):
    return (d - e[0, 0] - x * e[0, 1] - y * e[0, 2]) / (
...
def POLY21(e, x, y, t):
    return (
        ...
        + x * e[0, 1]
        + y * e[0, 2]
        + t * (e[1, 0] + x * e[1, 1] + y * e[1, 2])
        + t**2 * (e[2, 0] + x * e[2, 1] + y * e[2, 2])
    )


def DPOLY21(e, x, y, t):
    return (e[1, 0] + x * e[1, 1] + y * e[1, 2]) + 2 * t * (
        e[2, 0] + x * e[2, 1] + y * e[2, 2]
    )
