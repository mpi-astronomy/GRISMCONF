...
class Config:
    ...
    def __init_GRISMCONF(self, GRISM_CONF: str, DIRFILTER: str = None) -> None:
        ...
        self.orders = self._get_grism_orders(self.GRISM_CONF)
    ...
    def _get_sensitivity(self, order):
        ...
        fname = os.path.join(
            self.GRISM_CONF_PATH, self._get_value("SENSITIVITY_%s" % (order))
        )
